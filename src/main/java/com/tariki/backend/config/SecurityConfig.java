    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/livraisons/*/reception").hasRole("CLIENT")
                .requestMatchers("/api/livraisons/*/invitation").hasAnyRole("ENTREPRISE", "ADMIN")
                .requestMatchers(HttpMethod.PATCH, "/api/entreprises/*/facturation").hasAnyRole("ENTREPRISE", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/tracking", "/api/tracking/**").authenticated()
